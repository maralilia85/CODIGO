...
public class CatGeneral implements Serializable {
    ...
    @Column(name = "GEN_VALOR")
    private String genValor;
    @Column(name = "GEN_OBSERVACION")
    private String genObservacion;
    ...
    public String getGenValor() {
        return genValor;
    }

    public void setGenValor(String genValor) {
        this.genValor = genValor;
    }

    public String getGenObservacion() {
        return genObservacion;
    }

    public void setGenObservacion(String genObservacion) {
        this.genObservacion = genObservacion;
    }
