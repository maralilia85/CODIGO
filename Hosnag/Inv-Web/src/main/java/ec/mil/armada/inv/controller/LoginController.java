...
public class LoginController implements Serializable {
 ...
 System.out.println("Texto desencriptado: "+decrypt(key, iv,encrypt(key, iv,cleartext)));
   ...
   public void encriptaDesencrita(String clave, String tipo) {
   if(tipo.equalsIgnoreCase("E")){
   char arrayE[] = clave.toCharArray();
       for (int i = 0; i < clave.length(); i++) {
           
           arrayE[i] = (char)(arrayE[i] + (char)5);
           
       }
       String encripta = String.valueOf(arrayE);
   ...
   String desencripta = String.valueOf(arrayD);
       System.out.println("d"+desencripta);
   }
   }
}
